...
get-mailbox hr@constructif.nl | Set-Mailbox -MessageCopyForSendOnBehalfEnabled $true
get-mailbox hr@constructif.nl | Set-Mailbox -MessageCopyForSentAsEnabled $true
