...
$DefaultCSVPath = Join-Path 'C:\temp' "ADComputers_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
$CSVpath = Resolve-ExportFilePath -Path $CSVpath -DefaultPath $DefaultCSVPath -Prompt 'CSV-exportbestand'
